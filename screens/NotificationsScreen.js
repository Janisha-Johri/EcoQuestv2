...
export default function NotificationsScreen({ navigation }) {
  // Start empty — real notifications will come from Firebase later
...
const styles = StyleSheet.create({
  ...
  backBtn:  { paddingHorizontal: SPACING.base, paddingTop: SPACING.md },
  ...
  dismiss:   { fontSize: 20, color: COLORS.textMuted },
